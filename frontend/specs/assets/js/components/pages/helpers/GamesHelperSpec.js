...
describe('GamesHelper', function() {
  describe('.render', function() {
    it('renders game cards for each game', function() {
      const games = [
        { name: 'Game A', game_slug: 'game-a', cover_photo_path: null },
        { name: 'Game B', game_slug: 'game-b', cover_photo_path: null },
      ];
    ...
    it('renders pagination when there are multiple pages', function() {
      const games = [{ name: 'Game A', game_slug: 'game-a', cover_photo_path: null }];
