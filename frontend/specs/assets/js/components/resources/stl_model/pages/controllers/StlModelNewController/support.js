...
/**
 * @description Builds fresh spies shared by every StlModelNewController spec file.
 ...
 *   shared by every StlModelNewController spec file. Must be called from a `beforeEach`/`it` body.
