...
describe('RemoveTreasureTab', function() {
  ...
  const renderTab = (props = {}) => {
    ...
    spyOn(RemoveTreasureTabHelper, 'render').and.callFake((state, handlers) => {
      capturedState = state;
      capturedHandlers = handlers;
      return React.createElement('div', null, 'remove-tab');
    });

    renderToStaticMarkup(
      React.createElement(RemoveTreasureTab, {
        show: true,
        character,
  ...
  beforeEach(function() {
    spyOn(RemoveTreasureTabController.prototype, 'loadPage').and.callFake(neverResolves);
  });
  ...
  it('loads the previous page via the controller when onPrev is triggered', function() {
    ...
    expect(RemoveTreasureTabController.prototype.loadPage)
