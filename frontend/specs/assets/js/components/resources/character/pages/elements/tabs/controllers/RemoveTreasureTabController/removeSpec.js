...
describe('RemoveTreasureTabController', function() {
  describe('#remove', function() {
    it('returns ok with the new quantity and money on success', async function() {
      ...
      const result = await controller.remove('demo', 7, true, { treasureId: 9, quantity: 1 });
    ...
    it('resolves the npc kind when isPc is false', async function() {
      ...
      await controller.remove('demo', 7, false, { treasureId: 9, quantity: 1 });
    ...
    it('maps the not enough owned error message to its translation key', async function() {
      ...
      const result = await controller.remove('demo', 7, true, { treasureId: 9, quantity: 100 });
