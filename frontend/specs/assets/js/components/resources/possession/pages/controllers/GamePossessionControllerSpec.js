import GamePossessionController
  from '../../../../../../../../assets/js/components/resources/possession/pages/controllers/GamePossessionController.js';
import AccessStore from '../../../../../../../../assets/js/utils/access/store/AccessStore.js';
import RequestStore from '../../../../../../../../assets/js/utils/requests/RequestStore.js';

describe('GamePossessionController', function() {
  let setPossession;
  let setLoading;
  let setError;
  let setCanEdit;
  ...
  describe('.getParamsFromHash', function() {
    it('extracts the game slug and possession id', function() {
      expect(GamePossessionController.getParamsFromHash('#/games/demo/possessions/5')).toEqual({
        game_slug: 'demo', id: '5',
      });
    });

    it('defaults to empty strings for a non-matching hash', function() {
      expect(GamePossessionController.getParamsFromHash('#/games/demo')).toEqual({
        game_slug: '', id: '',
      });
    });
  });
  ...
  describe('#buildEffect', function() {
    it('fetches the possession through RequestStore', async function() {
      const cleanup = new GamePossessionController(
        setPossession, setLoading, setError, setCanEdit, setCanUploadPhoto, client,
      ).buildEffect()();
  ...
  describe('canUploadPhoto', function() {
    ...
    it('calls ensureGameAccess with the game slug independently of the possession fetch', async function() {
      await runController();
