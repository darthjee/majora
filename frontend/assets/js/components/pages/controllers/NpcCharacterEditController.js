...
import { resolveLoadedCharacter } from './PcCharacterEditController.js';
 ...
 */
export default class NpcCharacterEditController extends BasePageController {
  /**
  ...
  constructor(
    ...
    this.loadController = new NpcCharacterController(
      setCharacter,
      setLoading,
      setError,
      this.client,
  ...
  async handleSubmit(gameSlug, characterId, fields) {
    ...
    try {
      const response = await this.characterClient.updateNpc(gameSlug, characterId, token, fields);
   ...
   * to {@link NpcCharacterEditController#handleSubmit}.
   *
