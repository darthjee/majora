...
/**
 * Rendering helper for the PC Character Photos listing page.
 */
export default class PcCharacterPhotosHelper {
  /**
    ...
    return (
      <div className="container mt-4">
        <PageActions backHref={backHref}>
          {PcCharacterPhotosHelper.#renderUploadButton(canEdit, handlers)}
        </PageActions>
        <h1 className="mb-4">{Translator.t('pc_character_photos_page.title')}</h1>
        <div className="row">
          {photos.map((photo) => (
  ...
  static renderLoading() {
    return <LoadingMessage message={Translator.t('pc_character_photos_page.loading')} />;
  }
