...
/**
 * Rendering helper for the Character full detail page (editor view).
 */
export default class CharacterFullHelper {
  /**
   * Render the character full detail view, including DM notes.
   *
   ...
   * @returns {React.ReactElement} Character full detail element.
   */
  static render(character, backHref) {
    return (
      <div className="container mt-4">
        <BackButton href={backHref} />
        {CharacterFullHelper.#renderEditButton(character)}
        <div className="row">
        ...
        {CharacterFullHelper.#renderPrivateDescription(character.private_description)}
  ...
  static renderLoading() {
    return <LoadingMessage message={Translator.t('character_full_page.loading')} />;
  }
