...
const ID_KEYS = { new: 'game-treasure-new-name', edit: 'game-treasure-edit-name' };
const LABEL_KEYS = {
  new: 'game_treasure_new_page.name_label',
  edit: 'game_treasure_edit_page.name_label',
};

/**
 * New/edit-mode right-column slot: the treasure's name field.
 *
 ...
 */
export default function TreasureNameField({ mode, name, fieldErrors = {}, handlers }) {
  return (
    <FormField
      id={ID_KEYS[mode]}
      type="text"
