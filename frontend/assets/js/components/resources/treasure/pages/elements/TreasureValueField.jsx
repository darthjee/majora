...
/**
 * Collapsed CP/SP/GP value display used on treasure new/edit forms, paired
 ...
 * @param {string|number} props.value - Current treasure value, expressed in copper pieces.
...
export default function TreasureValueField({
  label, editLabel, value, errors = [], onOpenModal,
}) {
  return (
    <div className="mb-3">
      <label className="form-label">{label}</label>
      <div><TreasureMoney value={Number(value) || 0} /></div>
