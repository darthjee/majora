 ...
 * `context` (`photo_path`, `name`, `can_edit`, `mode`, `handlers.onOpenUploadModal`)
 ...
 * @param {string|null} [context.photo_path] - Photo URL.
...
export default function GameCoverPhoto({
  photo_path: coverPhotoPath, name, can_edit: canEdit, mode, handlers,
}) {
  return (
    <ActionsOverlay
      url={coverPhotoPath}
