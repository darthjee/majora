...
const SUBMIT_KEYS = { new: 'game_new_page.submit', edit: 'game_edit_page.submit' };

/**
 * New/edit-mode right-column slot: the form's submit button, disabled while a submission is
 * in flight.
 *
 ...
 */
export default function GameSubmitButton({ mode, status }) {
  return (
