...
const ID_KEYS = { new: 'possession-new-name', edit: 'possession-edit-name' };
const LABEL_KEYS = { new: 'possession_new_page.name_label', edit: 'possession_edit_page.name_label' };

/**
 * New/edit-mode right-column slot: the possession's name field, mirroring `ItemNameField`.
 *
 ...
 */
export default function PossessionNameField({ mode, name, fieldErrors = {}, handlers }) {
  return (
    <FormField
      id={ID_KEYS[mode]}
      type="text"
