...
export default class GameNpcNewHelper {
   ...
   *   (`CharacterHiddenSlot`, `CharacterIncognitoSlot`, `CharacterAllegianceFieldsSlot`,
   *   `CharacterDmNotesSlot`, `CharacterMoneySlot`) hide their private/full-only fields for
   *   reduced-access creators.
   ...
   *   onHiddenChange: Function, onIncognitoChange: Function, onPrivateAllegianceChange: Function,
