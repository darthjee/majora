...
/**
 * Controller for the PC/NPC item detail page (issue #724), shared by `PcCharacterItem` and
 * `NpcCharacterItem` via the `characterKind` constructor argument, mirroring
 * `GameItemController`'s single-object `client.fetch(path)` usage but gated on the requester's
