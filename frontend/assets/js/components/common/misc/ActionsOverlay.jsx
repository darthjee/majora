 ...
 * @param {'photo'|'avatar'|'treasure'|'item'|'possession'|'document'|'stl_model'|'source'|'collection'} [props.type] - Which
 ...
 *   {@link CardCollectionImage}, anything else (default) uses {@link CardPhoto}.
