 ...
 * @param {boolean} props.loading - Whether the caller's fetch is still in flight.
 * @param {number} props.total - Total item count (from pagination metadata), shown in the title.
 * @param {boolean} props.defaultCollapsed - Collapse state to adopt, and keep re-syncing to,
 *   until the user manually toggles the section.
...
export default function PreviewSection({
  ...
  loading, total, defaultCollapsed,
}) {
