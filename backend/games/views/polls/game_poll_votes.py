...
def _cast_votes(request, poll):
    ...
    if poll.status != Poll.STATUS_OPEN:
        return Response({'errors': {'detail': ['poll_not_open']}}, status=400)
    ...
    try:
        ...
        # see #1163
        votes = writer_cls.write(  # nosemgrep: python.django.security.injection.request-data-write.request-data-write  # noqa: E501
