...
class TestGameNpcFactionRemoveView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/npcs/<id>/factions/<faction_id>/remove.json."""
    ...
    def _url(self, faction_id=None, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/factions/{faction_id}/remove.json'
    ...
    def test_removing_never_enlisted_faction_returns_404(self, client):
        ...
        response = self._post(client, token=self.dm_token, faction_id=other_faction.id)
