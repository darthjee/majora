"""Tests for the NPC items/all.json view (DM/superuser only, includes hidden)."""
...
class TestGameNpcItemsAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/items/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an unrelated user, an NPC, and visible/hidden items."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/items/all.json'
