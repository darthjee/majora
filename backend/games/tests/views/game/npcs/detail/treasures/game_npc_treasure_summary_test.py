"""Tests for the NPC treasure quantity summary endpoint (open to everyone, hidden-npc gated)."""
...
class TestGameNpcTreasureSummaryView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/treasures/<treasure_id>/npcs/<character_id>/summary.json."""

    def setup_method(self):
        """Set up a game, an NPC, and a treasure."""
    ...
    def _url(self, treasure_id=None, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/treasures/{treasure_id}/npcs/{character_id}/summary.json'

    def test_returns_zero_quantity_when_not_owned(self, client):
        """Test that quantity is 0 when the NPC owns none of the treasure."""
