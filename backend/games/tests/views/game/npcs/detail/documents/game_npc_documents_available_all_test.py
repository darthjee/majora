"""Tests for the DM-only NPC documents/available/all.json view (includes hidden documents)."""
...
class TestGameNpcDocumentsAvailableAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/documents/available/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an unrelated user, an NPC, an owned document, and a hidden one."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/documents/available/all.json'
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-npc-documents-available-all',
