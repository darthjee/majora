"""Tests for the DM-only NPC document remove-all endpoint (accepts hidden documents)."""
...
class TestGameNpcDocumentRemoveAllView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/npcs/<id>/documents/remove/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an NPC, an unrelated user, and a hidden owned document."""
    ...
    def _url(self, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/documents/remove/all.json'
    ...
    def test_dm_can_remove_a_hidden_document(self, client):
        """Test that a DM can remove a hidden document on behalf of an NPC via the all-variant."""
