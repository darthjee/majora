"""Tests for the NPC document files/all.json view (DM/superuser only)."""
...
class TestGameNpcDocumentFilesAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/documents/<document_id>/files/all.json."""
    ...
    def _url(self, document_id=None, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/documents/{document_id}/files/all.json'
    ...
    def test_ignores_incognito(self, client):
        """Test that an incognito NPC's files still list, unlike the public endpoint."""
