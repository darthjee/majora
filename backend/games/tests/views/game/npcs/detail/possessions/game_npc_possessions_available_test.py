"""Tests for the NPC possessions/available.json view."""
...
class TestGameNpcPossessionsAvailableView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/possessions/available.json."""

    def setup_method(self):
        """Set up a game, an NPC, an owned possession, an available one, and a hidden one."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/possessions/available.json'
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-npc-possessions-available',
