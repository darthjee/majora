"""Tests for the NPC possessions/all.json view (DM/superuser only, includes hidden)."""
...
class TestGameNpcPossessionsAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/possessions/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an unrelated user, an NPC, and visible/hidden possessions."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/possessions/all.json'
