"""Tests for the DM-only NPC possession acquire-all endpoint (accepts hidden possessions)."""
...
class TestGameNpcPossessionAcquireAllView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/npcs/<id>/possessions/acquire/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an NPC, an unrelated user, and a hidden game possession."""
    ...
    def _url(self, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/possessions/acquire/all.json'
    ...
    def test_dm_can_acquire_a_hidden_possession_on_behalf_of_an_npc(self, client):
        """Test that a DM can acquire a hidden possession for an NPC via the all-variant."""
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-npc-possession-acquire-all',
