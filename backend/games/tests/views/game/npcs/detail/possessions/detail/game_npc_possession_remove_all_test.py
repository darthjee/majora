"""Tests for the DM-only NPC possession remove-all endpoint (accepts hidden possessions)."""
...
class TestGameNpcPossessionRemoveAllView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/npcs/<id>/possessions/remove/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an NPC, an unrelated user, and a hidden owned possession."""
    ...
    def _url(self, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/possessions/remove/all.json'
    ...
    def test_dm_can_remove_a_hidden_possession(self, client):
        """Test that a DM can remove a hidden possession on behalf of an NPC via the all-variant."""
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-npc-possession-remove-all',
