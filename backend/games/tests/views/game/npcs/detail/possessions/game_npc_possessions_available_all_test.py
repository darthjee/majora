"""Tests for the DM-only NPC possessions/available/all.json view (includes hidden)."""
...
class TestGameNpcPossessionsAvailableAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/npcs/<id>/possessions/available/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an unrelated user, an NPC, an owned possession, and a hidden one."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/npcs/{character_id}/possessions/available/all.json'
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-npc-possessions-available-all',
