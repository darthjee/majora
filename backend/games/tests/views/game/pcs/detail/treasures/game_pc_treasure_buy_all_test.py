"""Tests for the DM-only PC treasure buy-all endpoint (accepts hidden treasures)."""
...
class TestGamePcTreasureBuyAllView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/pcs/<id>/treasures/buy/all.json."""
    ...
    def _url(self, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/treasures/buy/all.json'
    ...
    def test_dm_can_buy_a_hidden_treasure_on_behalf_of_a_pc(self, client):
        """Test that a DM can buy a hidden treasure on behalf of a PC via the all-variant."""
