"""Tests for the PC document photos-list view."""
...
class TestGamePcDocumentPhotosView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/pcs/<id>/documents/<document_id>/photos.json."""
    ...
    def _url(self, document_id=None, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/documents/{document_id}/photos.json'
    ...
    def test_respects_page_param(self, client):
        ...
        for i in range(5):
            GameDocumentPhoto.objects.create(
                path=f'photos/games/test-game/documents/1/photo-{i}.png',
                game_document=self.game_document,
                ready=True,
            )
