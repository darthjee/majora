"""Tests for the PC document photos/all.json view (dm, owner, or admin only)."""
...
class TestGamePcDocumentPhotosAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/pcs/<id>/documents/<document_id>/photos/all.json."""
    ...
    def _url(self, document_id=None, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/documents/{document_id}/photos/all.json'
    ...
    def test_owner_gets_200_for_hidden_document_photos(self, client):
        """Test that the PC's owning player gets 200 with photos from a hidden document."""
    ...
    def test_dm_gets_200_for_hidden_document_photos(self, client):
        """Test that the game's DM gets 200 with photos from a hidden document."""
    ...
    def test_ignores_incognito(self, client):
        """Test that an incognito character's photos still list, unlike the public endpoint."""
