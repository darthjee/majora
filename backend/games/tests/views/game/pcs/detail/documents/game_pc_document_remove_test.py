"""Tests for the PC document remove endpoint."""
...
class TestGamePcDocumentRemoveView(TokenAuthRequestMixin):
    """Tests for POST /games/<slug>/pcs/<id>/documents/remove.json."""

    def setup_method(self):
        """Set up a game, a PC owning a document, an owning player/user, and a DM."""
    ...
    def _url(self, character_id=None, game_slug=None):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/documents/remove.json'
    ...
    def test_editor_can_remove_document(self, client):
        """Test that an authorized editor can remove an owned document."""
        response = self._post(
    ...
    def test_dm_can_remove_document(self, client):
        """Test that a DM of the game can remove a document on behalf of a PC."""
        response = self._post(
    ...
    def test_staff_can_remove_document(self, client):
        """Test that a global Staff user, neither owner nor DM, can remove a document for a PC."""
    ...
    def test_plain_player_can_remove_document(self, client):
        """Test that a plain player of the game (not staff/owner/dm) can remove for another PC."""
        response = self._post(
