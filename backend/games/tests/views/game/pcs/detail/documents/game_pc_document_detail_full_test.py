"""Tests for the PC document detail/full.json view (dm, owner, or admin only; incl. hidden)."""
...
class TestGamePcDocumentDetailFullView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/pcs/<id>/documents/<document_id>/full.json."""
    ...
    def _url(self, document_id=None, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/documents/{document_id}/full.json'
    ...
    def test_owner_gets_200_for_hidden_document(self, client):
        """Test that the PC's owning player gets 200 for a hidden document."""
    ...
    def test_dm_gets_200_for_hidden_document(self, client):
        """Test that the game's DM gets 200 for a hidden document."""
