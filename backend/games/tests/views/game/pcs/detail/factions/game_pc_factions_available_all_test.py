"""Tests for the DM-only PC factions/available/all.json view."""
...
class TestGamePcFactionsAvailableAllView(TokenAuthRequestMixin):
    """Tests for GET /games/<slug>/pcs/<id>/factions/available/all.json."""

    def setup_method(self):
        """Set up a game, a DM, an owner, an enlisted faction, and an available faction."""
    ...
    def _url(self, character_id=None, game_slug='test-game'):
        ...
        return f'/games/{game_slug}/pcs/{character_id}/factions/available/all.json'
    ...
    def test_url_by_name(self, client):
        ...
        url = reverse(
            'game-pc-factions-available-all',
