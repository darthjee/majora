"""Tests for the entity-agnostic game possession permissions-check endpoint (issue #1099)."""
...
class TestGamePossessionPermissionsView(TokenAuthRequestMixin, TestCase):
    """Tests for the GET /permissions/game_possession.json endpoint."""
    ...
    def _get(self, client, token=None, query=''):
        """Issue a GET request to the game possession permissions endpoint."""
    ...
    def test_url_by_name(self):
        ...
        url = reverse('permissions-game-possession')
