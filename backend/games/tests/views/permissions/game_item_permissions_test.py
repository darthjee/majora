"""Tests for the entity-agnostic game item permissions-check endpoint (issue #1099)."""
...
class TestGameItemPermissionsView(TokenAuthRequestMixin, TestCase):
    """Tests for the GET /permissions/game_item.json endpoint."""
    ...
    def _get(self, client, token=None, query=''):
        """Issue a GET request to the game item permissions endpoint."""
    ...
    def test_url_by_name(self):
        ...
        url = reverse('permissions-game-item')
