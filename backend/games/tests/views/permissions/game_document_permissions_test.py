"""Tests for the entity-agnostic game document permissions-check endpoint (issue #1099)."""
...
class TestGameDocumentPermissionsView(TokenAuthRequestMixin, TestCase):
    """Tests for the GET /permissions/game_document.json endpoint."""
    ...
    def _get(self, client, token=None, query=''):
        """Issue a GET request to the game document permissions endpoint."""
    ...
    def test_url_by_name(self):
        ...
        url = reverse('permissions-game-document')
