"""Tests for the entity-agnostic game common item permissions-check endpoint (issue #826)."""
...
class TestGameCommonItemPermissionsView(TokenAuthRequestMixin, TestCase):
    """Tests for the GET /permissions/game_common_item.json endpoint."""
    ...
    def _get(self, client, token=None, query=''):
        """Issue a GET request to the game common item permissions endpoint."""
    ...
    def test_url_by_name(self):
        ...
        url = reverse('permissions-game-common-item')
