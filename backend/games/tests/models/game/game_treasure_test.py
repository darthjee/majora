...
class TestGameTreasure(TestCase):
    ...
    def test_game_treasure_creation(self):
        ...
        game_treasure = GameTreasure.objects.create(
            game=self.game, treasure=self.treasure, max_units=10,
        )
    ...
    def test_max_units_defaults_to_none(self):
        ...
        game_treasure = GameTreasure.objects.create(game=self.game, treasure=self.treasure)
    ...
    def test_game_treasure_str(self):
        ...
        game_treasure = GameTreasure(game=self.game, treasure=self.treasure)
    ...
    def test_game_treasure_ordering(self):
        ...
        first = GameTreasure.objects.create(game=self.game, treasure=self.treasure)
        second_treasure = TreasureFactory(name='Silver Sword', value=100)
        second = GameTreasure.objects.create(game=self.game, treasure=second_treasure)
...
class TestGameTreasureAvailableUnits(TestCase):
    ...
    def test_available_units_is_max_minus_acquired(self):
        ...
        game_treasure = GameTreasure(
            game=self.game, treasure=self.treasure, max_units=10, acquired_units=4,
        )
    ...
    def test_available_units_is_zero_when_fully_acquired(self):
        ...
        game_treasure = GameTreasure(
            game=self.game, treasure=self.treasure, max_units=5, acquired_units=5,
        )
    ...
    def test_available_units_never_negative(self):
        ...
        game_treasure = GameTreasure(
            game=self.game, treasure=self.treasure, max_units=5, acquired_units=8,
        )
        assert game_treasure.available_units == 0
