"""Game item permissions serializer for the games app."""
...
class GameItemPermissionsSerializer(BasePermissionsSerializer):
    """Serializes the can_edit flag for the entity-agnostic game item permissions.json."""

    def to_representation(self, instance):
        """Build the permissions response dict via the YAML-driven `PermissionsBuilder`.

        `instance` is always `None` (the entity-agnostic `/permissions/game_item.json`
