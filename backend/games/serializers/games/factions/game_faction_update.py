"""Faction update serializer for the games app."""
...
class FactionUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        """Metadata for the FactionUpdateSerializer."""
    ...
    def validate_name(self, value):
        ...
        clashing = Faction.objects.filter(game_id=game_id, name=value).exclude(pk=self.instance.pk)
        if clashing.exists():
