 ...
 * split across npcs.php, pcs.php, treasures.php, sessions.php, and
 * items.php in this same folder, so both environments share a single
 * source instead of duplicating the map verbatim.
 */
